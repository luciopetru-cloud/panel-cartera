...
// Datos Mock iniciales simulando la respuesta combinada de Supabase y la API financiera
const INITIAL_PROFILE = { total_capital_allocated: 50000.00 };
const INITIAL_TRANSACTIONS = [
  { ticker: 'AAPL', asset_type: 'STOCK', operation_type: 'BUY', quantity: 10, price: 150.00 },
  { ticker: 'AAPL', asset_type: 'STOCK', operation_type: 'BUY', quantity: 5, price: 160.00 },
  { ticker: 'BTC', asset_type: 'CRYPTO', operation_type: 'BUY', quantity: 0.5, price: 60000.00 },
  { ticker: 'SPY', asset_type: 'ETF', operation_type: 'BUY', quantity: 20, price: 400.00 },
  { ticker: 'SPY', asset_type: 'ETF', operation_type: 'SELL', quantity: 5, price: 420.00 }
];

const MARKET_DATA_MOCK = {
  'AAPL': { currentPrice: 175.50, previousClose: 173.00, dailyChangePercent: 1.44, sentiment: 'Compra' },
  'BTC': { currentPrice: 64500.00, previousClose: 66000.00, dailyChangePercent: -2.27, sentiment: 'Compra Fuerte' },
  'SPY': { currentPrice: 425.20, previousClose: 424.00, dailyChangePercent: 0.28, sentiment: 'Mantener' }
};
            ...
            {activeAssets.map(asset => {
              ...
              return (
                <tr key={asset.ticker} style={{ borderBottom: '1px solid #e2e8f0' }}>
                  ...
                  <td style={{ padding: '10px' }}>{asset.totalQty.toFixed(4)}</td>
